...
\begin{center}
    ...
    \captionof{figure}{A $g_{F}$ faktorok méréséhez használt rádiófrekvenciák jelalakjai. A mérés során a jelgenerátor 4 különböző pozícióját használtuk, melyeket a $4$, $6$, $7$ és $8$ számokkal jelzünk a műszer beosztása skálája.} \label{fig:20}
\end{center}
\begin{center}
...
\begin{center}
    ...
    \captionof{figure}{A $g_{F}$ faktorok meghatározásához kimért $\mu_{B} B^{\ast} = h \nu$ rezonanciákra illesztett egyenesek. A mérőműszer hibájából fakadóan csak az $I = 3/2$ magspinű $^{87}$Rb izotópokhoz tartozó $g_{F} \approx 1/2$ értéket tudtuk mindkét illesztésből kimutatni.} \label{fig:22}
\end{center}
\vspace*{\fill}